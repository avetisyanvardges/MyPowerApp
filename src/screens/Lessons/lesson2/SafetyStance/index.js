...
import Audio from '../../../../assets/Lesson2SafetyStance.mp3';
...
const SafetyStance = () => {
  ...
  return (
    <VerticalAudio
      ...
      onPress={() => navigation.navigate('PreVideo')}
      closePress={() => navigation.navigate('PreVideo')}
